...
<div class="clearfix tabs-section">
    ...
    <div class="col-md-10">
        ...
        <div class=" white-3  mb30 message">
            <div class="clearfix">
                <div class="col-md-8">
                    ...
                    <h1 class="mt0 pt10"><i class="fas fa-user-edit"></i>message sender :
                        <span><?php echo getSenderName($message->sender_id)->name ;  ?></span>
                    </h1>
                </div>
                <div class="col-md-4">
            ...
            <form action="{{route('reply_message_from_admin')}}" method="post">
                @csrf
                <div id="collapseThree" class="clearfix edit collapse mb30" aria-labelledby="headingTwo"
                    ...
                    <div class="clearfix">
                        ...
                        <input type="hidden"  name="sender_id" value="{{ isset($message)? $message->sender_id : '' }}">
